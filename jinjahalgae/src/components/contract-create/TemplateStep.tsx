            ...
            <p className="leading-relaxed text-base">
              {formData.oneOff ? (
                <>
                  ...
                  이(가) <span className="basic-highlight">감독자의 참여 시점을 기준으로 24시간 이내에</span>{" "}
                  <span className="basic-highlight">
            ...
            <p>
              {formData.oneOff ? (
                <>
                  ...
                  은(는), <span className="highlight">입회인이 지켜보기 시작한 시점부터 열두 시진(二十四時間) 안에</span>{" "}
                  <span className="highlight">
                    '{formData.title || "[목표 제목]"}'
                  </span>
                  을(를) 완수할 것을 천지신명께 고하노라.
                </>
              ) : (
                <>
                  본인 <span className="highlight">{contractorName}</span>
                  은(는), <span className="highlight">{startDate}</span>부터{" "}
                  <span className="highlight">{endDate}</span>까지{" "}
                  <span className="highlight">
                    '{formData.title || "[목표 제목]"}'
                  </span>
        ...
        <div className="casual-content space-y-6">
          <div>
            ...
            <p className="leading-relaxed text-base mb-4">
              {formData.oneOff ? (
                <>
                  {contractorName}은(는) <span className="casual-highlight">감시단이 참여하는 순간부터 24시간 내로</span>{" "}
            ...
            <p className="mt-2 text-lg mb-4 leading-relaxed">
              {formData.oneOff ? (
                <>
                  ...
                  , <span className="child-highlight">감시단 뜨는 순간부터 24시간 안에</span> '{formData.title || "[목표 제목]"}
                  ' 이거 무조건 깨야 함. ㅇㅋ?
                </>
              ) : (
                <>
            ...
            <p className="mt-2 text-lg mb-4 leading-relaxed">
              {formData.oneOff ? (
                <>
                  ...
                  는(은), <span className="baby-highlight">지켜보는 친구가 응원을 시작하면 하루(24시간) 안에</span>{" "}
                  <span className="baby-highlight">
                    {formData.title || "[목표 제목]"}
                  </span>{" "}
                  꼭 해낼 거예요!

...
export function Modal({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 flex items-center justify-center bg-black !bg-opacity-30 backdrop-blur-sm transition-all duration-300 p-4"
...
export function BottomSheet({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-end justify-center bg-black bg-opacity-30 backdrop-blur-sm transition-all duration-300"
      onClick={handleBackdropClick}
